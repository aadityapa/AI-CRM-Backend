...
EVENTS: list[dict] = [
    ...
    {"event": "interview.integrity_alert",
     "label": "AI interview terminated / integrity alert",
     "description": "Sent to the TA who scheduled an AI interview when the server terminates it for "
    ...
    {"event": "support.ticket_raised",
     ...
     "description": "Sent when someone raises a ticket from the Help & Support bot (bottom-right) — "
                    "who, what page, category, priority and their description.",
     "default_roles": ["Admin", "CEO"]},
    {"event": "support.ticket_replied",
     "label": "Support ticket reply",
     "description": "Sent to the other side of a ticket conversation: the user when Admin replies, "
                    "Admin/CEO (or the assignee) when the user replies.",
     "default_roles": []},
    {"event": "support.ticket_status",
     "label": "Support ticket status changed",
     "description": "Sent to the person who raised the ticket when Admin marks it In progress / Resolved / Closed.",
     "default_roles": []},
    {"event": "support.ticket_assigned",
     "label": "Support ticket assigned",
     "description": "Sent to the Admin/CEO a ticket is assigned to.",
     "default_roles": []},
    {"event": "invoice.revision_requested",
     "label": "Invoice change requested",
     "description": "Sent when Sales/Finance ask to change a generated invoice (with their reason) — "
                    "to the approvers (Sales / Sales Head) and to Admin, CEO and Sales Head for tracking.",
     "default_roles": ["Sales", "Sales_Head", "Admin", "CEO"]},
    {"event": "invoice.revision_approved",
     "label": "Invoice change approved / applied",
     "description": "Sent when an invoice change request is approved and applied (or applied directly by "
                    "Admin/CEO) — includes the before → after of every field.",
     "default_roles": ["Admin", "CEO", "Sales_Head", "Finance"]},
    {"event": "invoice.revision_rejected",
